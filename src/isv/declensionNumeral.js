/**
 * Source:
 * https://github.com/sonic16x/interslavic/blob/master/src/legacy/declensionNumeral.ts
 */
...
export function declensionNumeralFlat(rawWord, numeralType) {
	const result = declensionNumeral(rawWord, numeralType);
	if (!result) {
		return [];
	}
	const forms = [];
...
export function declensionNumeral(rawWord, numeralType) {
