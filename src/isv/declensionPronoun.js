/**
 * Source:
 * https://github.com/sonic16x/interslavic/blob/master/src/legacy/declensionPronoun.ts
 */
import { declensionAdjective } from './declensionAdjective';

export function declensionPronounFlat(rawWord, pronounType) {
...
export function declensionPronoun(rawWord, pronounType) {
